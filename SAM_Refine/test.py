...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='testset/test1000/')
    ...
    parser.add_argument('--lora_ckpt', type=str, default='results\Synapse_512_pretrain_vit_b_epo100_bs16_lr9.9e-05\epoch_99.pth', help='The checkpoint from LoRA')
    ...
    if args.is_savenii:
        test_save_path = os.path.join(args.output_dir, 'predictions_bs4')
