...
parser.add_argument('--root_path', type=str,
                    default='SAM_FLARE', help='root dir for data')
...
parser.add_argument('--base_lr', type=float, default=0.000099,
...
# 指令：
# python train.py --warmup --AdamW --lora_ckpt D:/PycharmProjects/SAMed/results/Synapse_512_pretrain_vit_b_epo300_bs16_lr0.005/epoch_259.pth
# parser.add_argument('--ckpt', type=str, default='D:/PycharmProjects/SAMed/results/Synapse_512_pretrain_vit_b_epo300_bs16_lr0.005/epoch_259.pth',
#                     help='Pretrained checkpoint')
